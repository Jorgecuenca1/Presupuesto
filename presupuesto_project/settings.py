...
MIDDLEWARE = [
    ...
    'core.middleware.RecalculoAgrupadoMiddleware',
]

ROOT_URLCONF = 'presupuesto_project.urls'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'core.context_processors.vigencia_global',
            ],
        },
    },
]

WSGI_APPLICATION = 'presupuesto_project.wsgi.application'
