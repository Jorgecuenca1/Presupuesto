...
class ParametrosForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'valor_uvt': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            ...
            'poai_total_inversion': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            ...
            'valor_smlmv': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            ...
            'gasto_sev_ppto_nc': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'sgr_presupuesto': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'gasto_sev_sgr': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            ...
            'reservas_presupuestales_nc': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'cuentas_por_pagar_nc': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'superavit_fiscal': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'recaudo_oleoductos_anio_n3': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'recaudo_oleoductos_anio_n2': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'recaudo_oleoductos_anio_n1': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            'icld_calculado': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
            ...
            'subsidio_transporte_mensual': forms.NumberInput(attrs={'class': 'form-control', 'step': '1', 'min': '0'}),
