...
class ParametrosForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'valor_uvt': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            ...
            'poai_total_inversion': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            ...
            'valor_smlmv': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            ...
            'gasto_sev_ppto_nc': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'sgr_presupuesto': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'gasto_sev_sgr': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            ...
            'reservas_presupuestales_nc': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'cuentas_por_pagar_nc': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'superavit_fiscal': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'recaudo_oleoductos_anio_n3': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'recaudo_oleoductos_anio_n2': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'recaudo_oleoductos_anio_n1': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            'icld_calculado': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
            ...
            'subsidio_transporte_mensual': forms.TextInput(attrs={'class': 'form-control cop-format', 'inputmode': 'numeric', 'data-monetary': '1'}),
