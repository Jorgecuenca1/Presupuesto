...
URBANO_TIPOS = {
    ...
    'PUEBLO NUEVO (GETSEMANÍ)', 'PUEBLO NUEVO (GETSEMAN\u00cd)', 'PUEBLO NUEVO (GETSEMANI)',
    'BOCAS DEL GUAYURIBA', 'LA BALSA', 'CHAVIVA', 'GUICHIRAL', 'PUERTO PORFÍA',
    'PUERTO PORF\u00cdA', 'PUERTO PORFIA', 'ALTAMIRA', 'EL TIGRE', '13-CORREGIMIENTO 13',
}
